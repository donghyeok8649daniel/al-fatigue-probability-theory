...
def main():
    ...
    parser.add_argument('--climb-force-threshold',type=float,default=.03)
    ...
    result=relax_neb(evaluate,initial,spring=args.spring,max_steps=args.steps,progress=progress,
        ...
        max_image_move=args.max_image_move,climb_force_threshold=args.climb_force_threshold)
    ...
    save_json(args.output/'summary.json',dict(
        ...
        climb_force_threshold=args.climb_force_threshold,
