...
$\epsc,\epsw,\sigLJ$ & pair-law coefficient, pair well depth, and zero-crossing distance; energy,
energy, and length & Keep $\epsc=C_{m,n}\epsw$ explicit. Obtain them from a declared pair potential
or independent cohesive calibration; do not fit them to the fatigue loop.\\
...
$A_{\rm at},A_0,A_{\rm rep},A_{\rm cell}$ & area per atomic column, normal mechanical
representative area, registry repeat area, and interface-cell area; area & Compute atomic areas from
the declared lattice cell. Keep $A_0$, $A_{\rm rep}$, statistical correlation area, and FEM
element area distinct unless a geometry and counting derivation proves an equality.\\
