...
# - 주요 함수/메서드: _element_histories, _element_initiation_histories, write_initiation_element_history
#   write_probability_element_history, _last_cycle_indices, plot_probability_hysteresis_summary
#   plot_mesh_probability_fields, run_demo, main
